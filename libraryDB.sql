...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `AddBook` (IN `ChosenName` VARCHAR(100), IN `ChosenISBN` VARCHAR(50), IN `ChosenCategory` VARCHAR(100), IN `ChosenPublisher` VARCHAR(100), IN `ChosenEdition` INT(100), IN `ChosenAuthor` VARCHAR(100), IN `ChosenStockQuantity` INT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `AddMember` (IN `ChosenFirstName` VARCHAR(150), IN `ChosenSecondName` VARCHAR(150), IN `ChosenDOB` INT, IN `ChosenPostcode` VARCHAR(150), IN `ChosenEmailAddress` VARCHAR(150), IN `ChosenPasswords` VARCHAR(50))  BEGIN
   ...
   THEN SELECT '<div class="Results"> Email already in use. </div>'  AS RESULT;
   
   ELSE
   INSERT INTO member (FirstName, SecondName, DOB, Postcode, EmailAddress, Passwords)
   VALUES (ChosenFirstName, ChosenSecondName, ChosenDOB, ChosenPostcode, ChosenEmailAddress, ChosenPasswords);
   SELECT '<div class="Success"> Member added successfully </div>' AS RESULT;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SearchBook` (IN `SearchAuthorName` VARCHAR(100), IN `SearchBookName` VARCHAR(100), IN `SearchISBN` VARCHAR(50))  BEGIN
SELECT DISTINCT
book.BookID,
book.Name AS Title,
book.ISBN,
...
CREATE TABLE `member` (
  `MemberID` int(11) NOT NULL,
  `EmailAddress` varchar(100) NOT NULL DEFAULT 'test@email.com',
...
INSERT INTO `member` (`MemberID`, `EmailAddress`, `Passwords`, `FirstName`, `SecondName`, `DOB`, `Postcode`) VALUES
(1, 'test1@email.com', 'password', 'Jenny', 'Smith', '1993-02-01', 'HP22 4LX'),
(2, 'test2@email.com', 'password', 'Rachel', 'Trello', '1979-09-06', 'HU9 3NB'),
(3, 'test3@email.com', 'password', 'Laura', 'Abraham', '1939-08-03', 'LE65 1BE'),
(4, 'test4@email.com', 'password', 'Flo', 'Mulcahy', '1939-09-04', 'IV55 8WQ'),
(5, 'test5@email.com', 'password', 'Jo', 'Lovett', '1952-08-31', 'RM7 1PA'),
(6, 'test6@email.com', 'password', 'Dalia', 'Rice', '1954-03-13', 'TA16 5RD'),
(7, 'test7@email.com', 'password', 'Pawel', 'Gaines', '1959-05-06', 'ZE3 9JW'),
(8, 'test8@email.com', 'password', 'Ralphie', 'Brownie', '1970-11-07', 'IP15 5DY'),
(9, 'test9@email.com', 'password', 'Arian', 'Huynh', '1972-03-26', 'M30 0QT'),
(10, 'test10@email.com', 'password', 'Archibald', 'Dale', '1974-11-03', 'IV15 9HA'),
(11, 'test11@email.com', 'password', 'Miriam', 'Wilkinson', '1975-06-07', 'GU7 8HJ'),
(12, 'test12@email.com', 'password', 'Tana', 'Holmes', '1977-07-08', 'BA8 2EL'),
(13, 'test13@email.com', 'password', 'Amy', 'Key', '1977-11-22', 'EX14 1RG'),
(14, 'test14@email.com', 'password', 'Aradhana', 'Butcher', '1978-07-11', 'PR61HL'),
(15, 'test15@email.com', 'password', 'Sue', 'Tate', '1983-08-30', 'TD9 7ER'),
(16, 'test16@email.com', 'password', 'Artur', 'Novak', '1986-10-26', 'CF62 3DW'),
(17, 'test17@email.com', 'password', 'Lyla', 'Espiritu', '1999-07-12', 'CF47 9BG'),
(18, 'test18@email.com', 'password', 'Rosemarie', 'Santos', '1966-05-22', 'NE65 7SX'),
(19, 'test19@email.com', 'password', 'Isabella', 'Mendoza', '1989-09-29', 'PA2 0PF'),
(20, 'test20@email.com', 'password', 'Christian', 'Crisologo', '1947-12-25', 'LL49 9HF'),
(21, 'amanda.fluff@yahoo.com', 'password', 'Amanda', 'Fluff', '1988-06-12', 'SE17 9HH'),
(22, 'Jane.jumper@yahoo.com', 'password', 'Jane', 'Jumper', '1989-07-04', 'SE17 9PP'),
(23, 'dorothy.pillow@gmail.com', 'Any', 'Dorothy', 'Pillow', '0000-00-00', 'NW1 5GP'),
(24, 'DantheMan@yahoo.com', 'Mum', 'Dan', 'TheMan', '0000-00-00', 'NE1 2PP'),
(25, 'Pat@gmail.com', 'Tree', 'Pat', 'Nun', '0000-00-00', 'SW8 5TT'),
(26, 'George@yahoo.com', 'Flower', 'George', 'Mouse', '1963-06-02', 'SW6 2OP'),
(27, 'Paul@yahoo.com', 'Codenowsuccess', 'Paul', 'Hols', '1993-07-03', 'SW19 7PP'),
(28, 'Joe@yahoo.com', 'Codenowand%20ever', 'Joe', 'Shmoe', '1987-08-05', 'NW5 8TE');
